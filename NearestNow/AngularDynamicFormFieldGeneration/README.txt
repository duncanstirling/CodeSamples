                        LARAVEL CODE SAMPLE: USE OF ANGUAR.JS
...
Angular.js has been used to create dynamically generated menus when creating an advert. For example if a user wanted to place and advert in Texas, they would: 

1. select international
2. select USA from a list of international countries
3. select Texas from a list of American cities
