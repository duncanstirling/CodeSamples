...
#use MyLibrary\Stomp\StompFrame;

require LIBDIR.'autoload.php';

include 'Stomp/Frame.php';
include 'Stomp/Exception.php';
...
#require_once LIBDIR.'MyLibrary/library/MQ/Stomp/Frame.php';
#require_once LIBDIR.'MyLibrary/library/MQ/Stomp/StompFrame.php';
...
class Stomp
{
    ...
    /*
     * Return details of the broker we have connected to
     *
     * @return array
     */
    public function peer()
    {
      $peer = array ( 'host' => $this->_hosts[$this->_currentHost][0],
		      'port' => $this->_hosts[$this->_currentHost][1],
